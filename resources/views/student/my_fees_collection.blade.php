                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3><span style="color: blue"><b>Payment Detail</b> </span></h3>
                            </div>
                ...
                <form action="" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <label class="col-form-label">Remaning Amount: ${{ number_format($RemainingAmount,2)}} </label>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary closeModal" data-bs-dismiss="modal"        aria-label="Close">Close</button>
