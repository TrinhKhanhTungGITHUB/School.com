                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h4><span style="color: blue"><b>Search My Homework Submitted </b></span></h4>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-2 d-flex align-items-end justify-content-center">
                                            ...
                                            <div class="ml-1"> <a href="{{ url('student/my_submitted_homework') }}"
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4><span style="color: blue"><b>Homework Submit List</b></span></h4>
                            </div>
