        ...
        <section class="content">
            <div class="card">
                <div class="card-header">
                    <h5><span style="color: blue"><b>Search {{ $header_title }}</b></span></h5>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-3 d-flex align-items-end justify-content-center">
                                ...
                                <div class="ml-1">
                                    <a href="{{ url('teacher/my_exam_timetable') }}" class="btn btn-success">Reset</a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h2 class="d-flex justify-content-between">
                                        <span>Class Name : <span style="color: blue">{{ $class_name }}</span></span>
                                        <span>Exam Name: <b>{{ $exam_name }} </b></span>
                                    </h2>
                                </div>
                                        ...
                                        @foreach ($getRecord as $value)
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td> {{ date('d-m-Y', strtotime($value->exam_date)) }}
                                                    </td>
                                                    <td> {{ date('h:i A', strtotime($value->start_time)) }}
                                                    </td>
                                                    <td> {{ date('h:i A', strtotime($value->end_time)) }}
                                                    </td>
