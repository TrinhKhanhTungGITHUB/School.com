                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4><span style="color: blue"><b>Search Marks Register</b></span></h4>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-3 d-flex align-items-end justify-content-center">
                                            ...
                                            <div class="ml-1"> <a href="{{ url('teacher/marks_register') }}"
                        ...
                        @if (!empty($getSubject) && !empty($getSubject->count()))
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title"><span>Marks Register </span></h3>
                                </div>
