                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h4><span style="color: blue"><b>Search Student Submitted Homework </b></span></h4>
                            </div>
                            <form action="" method="GET">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-3">
                                            <label for="">From Submitted Created Date<span style="color: red">*</span></label>
                                            <input type="date" class="form-control" data-time=""
                                        ...
                                        <div class="form-group col-md-3">
                                            <label for="">To Submitted Created Date<span style="color: red">*</span></label>
                                            <input type="date" class="form-control" data-time=""
                                        ...
                                        <div class="form-group col-md-2 d-flex align-items-end justify-content-center">
                                            ...
                                            <div class="ml-1"> <a href="{{ url('parent/my_student/submitted_homework/'.$getStudent->id) }}"
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4><span style="color: blue"><b>Student Submitted Homework List </b></span></h4>
