    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>My Student Calendar <span style="color: blue;">{{ $getStudent->name }} {{ $getStudent->last_name}} </span></h1>
                    </div>
        ...
        @foreach ($getExamTimetable as $valueE)
            @foreach ($valueE['exam'] as $exam )
                events.push({
                    ...
                    color: 'red',
                    url: '{!! url("parent/my_student/exam_timetable/$getStudent->id?exam_id=" .$valueE['exam_id']) !!}'
