                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 style="color: blue"><span><b>Search Marks Register</b></span></h3>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-3 d-flex align-items-end justify-content-center">
                                            ...
                                            <div class="ml-1"> <a href="{{ url('admin/examinations/marks_register') }}"
                        ...
                        @if (!empty($getSubject) && !empty($getSubject->count()))
                            <div class="card">
                                <div class="card-header">
                                    <h4><span style="color: blue"><b>Marks Register </b></span></h4>
                                </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            @foreach ($getSubject as $subject)
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <div style="margin-bottom: 10px;">
                                                                        ...
                                                                        <button type="button"
                                                                            class="btn btn-primary SaveSingleSubject" style="text-align: center"
                                                                            id="{{ $student->id }}"
                                                            ...
                                                            <td style="min-width: 280px;">
                                                                ...
                                                                <a class="btn btn-primary " target="_blank"
                                                                    href="{{ url('admin/examinations/my_exam_result/print?exam_id=' . Request::get('exam_id') . '&student_id=' . $student->id) }}">Print</a>
                                                                ...
                                                                @if (!empty($totalStudentMark))
                                                                    ...
                                                                    <br>
                                                                    @php
                                                                        $percentage = ($totalStudentMark / $totalFullMarks) * 100;
